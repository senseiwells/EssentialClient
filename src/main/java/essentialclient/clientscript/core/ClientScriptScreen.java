...
public class ClientScriptScreen extends Screen {
	...
	protected void init() {
		...
		this.addDrawableChild(new ButtonWidget(10, this.height - 27, 100, 20, new LiteralText("Refresh"), button -> this.refresh()));
		...
		this.addDrawableChild(new ButtonWidget(this.width - 110, this.height - 27, 100, 20, new LiteralText(I18n.translate("Documentation")), button -> Util.getOperatingSystem().open(EssentialUtils.SCRIPT_WIKI_URL)));
		this.addDrawableChild(new ButtonWidget(10, 10, 50, 20, new LiteralText("New"), button -> this.createNewScript()));
		super.init();
	}
	...
	static class ScriptConfigScreen extends Screen {
		...
		protected void init() {
			...
			this.addDrawableChild(new ButtonWidget(halfWidth - 100, this.height - 27, 200, 20, new LiteralText(I18n.translate("gui.done")), button -> this.onClose()));
