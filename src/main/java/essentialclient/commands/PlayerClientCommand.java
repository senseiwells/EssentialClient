...
public class PlayerClientCommand {
	...
	public static int constructPlayer(CommandContext<ServerCommandSource> context, boolean isHere, boolean hasGamemode) throws CommandSyntaxException {
		...
		GameMode playerGamemode = hasGamemode ? GameMode.NOT_SET : EnumArgumentType.getEnumeration(context, "gamemode", GameMode.class);
	...
	private static int sendCommand(String playerName, PlayerData playerData, double x, double y, double z) throws CommandSyntaxException {
		...
		if (playerData.gamemode() != GameMode.NOT_SET && playerGameMode != playerData.gamemode()) {
