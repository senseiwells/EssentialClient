...
public class MinecraftFunction extends BuiltInFunction {
    ...
    public static void initialiseMinecraftFunctions() {
        ...
        new MinecraftFunction("look", List.of("yaw", "pitch"), function -> {
            ...
            assert client.player != null;
            client.player.setYaw(numberValue.value.floatValue());
            client.player.setPitch(numberValue2.value.floatValue());
            return new NullValue();
        }),
        ...
        new MinecraftFunction("getCurrentSlot", function -> {
            assert client.player != null;
            return new NumberValue(client.player.getInventory().selectedSlot + 1);
        }),

        new MinecraftFunction("getHeldItem", function -> {
            assert client.player != null;
            return new StringValue(Registry.ITEM.getId(client.player.getInventory().getMainHandStack().getItem()).getNamespace());
        }),
