...
public class ConfigScreen extends Screen
{
    ...
    protected void init() {
        ...
        ButtonWidget gameRuleButton = this.addButton(new ButtonWidget(this.width / 2 - 100, this.height / 6 + 48, 200, 20, new LiteralText("Gamerule Options"), (button -> this.client.openScreen(new GameRulesScreen(this)))));
