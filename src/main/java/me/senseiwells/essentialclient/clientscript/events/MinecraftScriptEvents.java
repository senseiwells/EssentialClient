...
import static me.senseiwells.arucas.utils.misc.Types.*;
...
public class MinecraftScriptEvents {
	...
	public static final MinecraftScriptEvent
		...
		ON_PLAYER_JOIN = register("onPlayerJoin", "This event is fired when a player joins the server", STRING, "name", "the player's name", STRING, "uuid", "the player's uuid"),
		ON_PLAYER_LEAVE = register("onPlayerLeave", "This event is fired when a player leaves the server", STRING, "name", "the player's name", STRING, "uuid", "the player's uuid"),
		...
		ON_RECEIVE_MESSAGE = registerCancellable("onReceiveMessage", "This event is fired when the player receives a message in chat", STRING, "uuid", "the sender's UUID", STRING, "message", "the message that was received", STRING, "type", "the type of message that was received; 'chat', 'say_command', 'msg_command_incoming', 'msg_command_outgoing', 'team_msg_command_incoming', 'team_msg_command_outgoing', and 'emote_command'"),
