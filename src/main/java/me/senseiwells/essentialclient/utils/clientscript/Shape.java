...
public abstract class Shape implements IArucasWrappedClass {
	...
	@FunctionDoc(
		...
		examples = "shape.setColor(0xFF0000);"
	)
	@ArucasFunction
	...
	@FunctionDoc(
		...
		throwMsgs = "Colour ... is out of bounds, must be between 0 - 255",
		examples = "shape.setColor(34, 55, 0);"
	)
	@ArucasFunction
	...
	@FunctionDoc(
		...
		examples = "shape.setOutlineColor(0xFF00FF);"
	)
	@ArucasFunction
	...
	@FunctionDoc(
		...
		examples = "shape.setOutlineColor(255, 0, 255);"
	)
	@ArucasFunction
	...
	@FunctionDoc(
		...
		examples = "shape.setOutlinePixelWidth(5);"
	)
	@ArucasFunction
	...
	public abstract static class CentrePositioned extends Shape {
		...
		@FunctionDoc(
			...
			examples = "shape.setPos(new Pos(0, 0, 0));"
		)
		@ArucasFunction
	...
	public abstract static class Positioned extends Shape {
		...
		@FunctionDoc(
			...
			examples = "shape.setPos2(new Pos(100, 0, 200));"
		)
		@ArucasFunction
		...
		@FunctionDoc(
			...
			examples = "shape.centerPositions();"
		)
		@ArucasFunction
	...
	public interface Directional {
		...
		@FunctionDoc(
			...
			examples = "shape.setDirection('down');"
		)
		@ArucasFunction
